...
const Hero = (props) => {
  ...
  return (
    <div
      ...
      className="min-h-screen mt-24 lg:mt-0 w-[96vw] lg:w-full h-full max-w-7xl ml-0 lg:ml-12 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-12"
    >
      <Spotlight
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-6 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start p-2">
        ...
        {banner.show_entrepreneur_count && (
